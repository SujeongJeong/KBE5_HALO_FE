    ...
    const fetchPendingInquiries = async () => {
      ...
      try {
        const [customer, manager] = await Promise.all([
          searchAdminInquiries("customer", { replyStatus: "PENDING", page: 0, size: 3 }),
          searchAdminInquiries("manager", { replyStatus: "PENDING", page: 0, size: 3 }),
        ]);
        const combined = [
          ...(customer.content || []).map((item: any) => ({ ...item, type: "customer" })),
          ...(manager.content || []).map((item: any) => ({ ...item, type: "manager" })),
        ];
        combined.sort((a, b) => {
        ...
        setTotalPendingInquiries((customer.page?.totalElements || 0) + (manager.page?.totalElements || 0));
      } catch (e) {
        setPendingInquiries([]);
        ...
        <div className="self-stretch flex-1 p-6 flex flex-col justify-start items-start gap-6">
          <div className="self-stretch flex flex-col justify-start items-start gap-4">
            <div className="self-stretch inline-flex justify-start items-start gap-4">
              <div className="flex-1 h-24 p-4 bg-white rounded-lg shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] inline-flex flex-col justify-start items-start gap-2">
                ...
                <div className="justify-start text-gray-900 text-2xl font-bold font-['Inter'] leading-7">{stats.totalReservation.value}</div>
                <div className="inline-flex justify-start items-center gap-1">
                  ...
                  <div className={`justify-start text-xs font-medium font-['Inter'] leading-none ${stats.totalReservation.trend.includes('감소') ? 'text-red-500' : 'text-emerald-500'}`}>{stats.totalReservation.trend}</div>
                </div>
              </div>
              <div className="flex-1 h-24 p-4 bg-white rounded-lg shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] inline-flex flex-col justify-start items-start gap-2">
                <div className="justify-start text-gray-500 text-sm font-medium font-['Inter'] leading-none">완료된 예약 건수</div>
                <div className="justify-start text-gray-900 text-2xl font-bold font-['Inter'] leading-7">{stats.completedReservation.value}</div>
                <div className="inline-flex justify-start items-center gap-1">
                  ...
                  <div className={`justify-start text-xs font-medium font-['Inter'] leading-none ${stats.completedReservation.trend.includes('감소') ? 'text-red-500' : 'text-emerald-500'}`}>{stats.completedReservation.trend}</div>
                </div>
              </div>
              <div className="flex-1 h-24 p-4 bg-white rounded-lg shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] inline-flex flex-col justify-start items-start gap-2">
                <div className="justify-start text-gray-500 text-sm font-medium font-['Inter'] leading-none">오늘의 예약 건수</div>
                <div className="justify-start text-gray-900 text-2xl font-bold font-['Inter'] leading-7">{stats.todayReservation.value}</div>
                <div className="inline-flex justify-start items-center gap-1">
                  ...
                  <div className={`justify-start text-xs font-medium font-['Inter'] leading-none ${stats.todayReservation.trend.includes('감소') ? 'text-red-500' : 'text-emerald-500'}`}>{getTrendText(stats.todayReservation.trend)}</div>
                </div>
              </div>
            </div>
            <div className="self-stretch inline-flex justify-start items-start gap-4">
              <div className="flex-1 h-24 p-4 bg-white rounded-lg shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] inline-flex flex-col justify-start items-start gap-2">
                ...
                <div className="justify-start text-gray-900 text-2xl font-bold font-['Inter'] leading-7">₩{stats.sales.value.toLocaleString()}</div>
                <div className="inline-flex justify-start items-center gap-1">
                  ...
                  <div className={`justify-start text-xs font-medium font-['Inter'] leading-none ${stats.sales.trend.includes('감소') ? 'text-red-500' : 'text-emerald-500'}`}>{stats.sales.trend}</div>
                </div>
              </div>
              <div className="flex-1 h-24 p-4 bg-white rounded-lg shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] inline-flex flex-col justify-start items-start gap-2">
                ...
                {newManagersTotal > 0 && (
                  <div className="px-2 py-0.5 bg-amber-50 rounded-xl inline-flex justify-center items-center">
                    <div className="justify-start text-amber-600 text-xs font-medium font-['Inter'] leading-none">확인 필요</div>
                  </div>
                )}
              </div>
              <div className="flex-1 h-24 p-4 bg-white rounded-lg shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] inline-flex flex-col justify-start items-start gap-2">
                ...
                {totalPendingInquiries > 0 && (
                  <div className="px-2 py-0.5 bg-amber-50 rounded-xl inline-flex justify-center items-center">
                    <div className="justify-start text-amber-600 text-xs font-medium font-['Inter'] leading-none">답변 필요</div>
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="self-stretch p-4 bg-white rounded-lg shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] flex flex-col justify-start items-start gap-4">
            <div className="self-stretch inline-flex justify-between items-center">
              ...
              <div className="justify-start text-gray-500 text-sm font-normal font-['Inter'] leading-none">{getTodayString()}</div>
            </div>
                ...
                >
                  <div className="flex justify-start items-center gap-3">
                    <div className="px-2 py-1 bg-indigo-100 rounded flex justify-center items-center">
                      <div className="justify-start text-indigo-600 text-xs font-medium font-['Inter'] leading-none">{schedule.time}</div>
                    </div>
                    <div className="inline-flex flex-col justify-start items-start gap-0.5">
                      <div className="justify-start text-gray-900 text-sm font-semibold font-['Inter'] leading-none">{schedule.title}</div>
                      <div className="justify-start text-gray-500 text-xs font-normal font-['Inter'] leading-none">{schedule.address}</div>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="self-stretch inline-flex justify-start items-start gap-6">
            <div className="flex-1 p-4 bg-white rounded-lg shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] inline-flex flex-col justify-start items-start gap-4">
              <div className="self-stretch inline-flex justify-between items-center">
                ...
                <div className="flex justify-start items-center gap-1 cursor-pointer" onClick={() => navigate('/admin/managers', { state: { tab: 'applied' } })}>
                  ...
                  newManagers.map((manager) => (
                    ...
                    >
                      <div className="flex justify-start items-center gap-3">
                        ...
                        <div className="inline-flex flex-col justify-start items-start gap-0.5">
                          <div className="justify-start text-gray-900 text-sm font-semibold font-['Inter'] leading-none">{manager.userName}</div>
                ...
                {pendingInquiriesLoading ? (
                  ...
                  pendingInquiries.map((inquiry) => (
                    <div
                      ...
                      className="self-stretch p-3 bg-gray-50 rounded-lg inline-flex justify-between items-center cursor-pointer transition-colors hover:bg-indigo-50"
                      onClick={() => navigate(`/admin/inquiries/${inquiry.type}/${inquiry.inquiryId}`, { state: { authorId: inquiry.authorId } })}
                    >
                      <div className="flex justify-start items-center gap-3">
                        <div className={`px-2 py-0.5 rounded-xl flex justify-center items-center ${inquiry.type === "customer" ? "bg-amber-100" : "bg-indigo-100"}`}>
                          <div className={`justify-start text-xs font-medium font-['Inter'] leading-none ${inquiry.type === "customer" ? "text-amber-600" : "text-indigo-600"}`}>
                            {inquiry.type === "customer" ? "고객" : "매니저"}
                          </div>
                        </div>
                        <div className="inline-flex flex-col justify-start items-start gap-0.5">
                          <div className="justify-start text-gray-900 text-sm font-semibold font-['Inter'] leading-none">{inquiry.title}</div>
                          <div className="justify-start text-gray-500 text-xs font-normal font-['Inter'] leading-none">{inquiry.createdAt}</div>
                        </div>
                      </div>
                    </div>
                  ))
