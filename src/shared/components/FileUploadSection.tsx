    ...
    <div className="self-stretch flex flex-col gap-2">
      ...
      <div className="self-stretch p-4 bg-slate-50 rounded-lg outline outline-1 outline-offset-[-1px] outline-slate-200 flex flex-col gap-3">
            ...
            <li key={index} className="flex items-center gap-2 text-sm text-slate-700">
              <div className="flex items-center gap-2 truncate grow">
                ...
                <button
                  ...
                  title="삭제"
                >
                  <span className="material-symbols-outlined text-sm align-text-bottom">close_small</span>
                </button>
              </div>
            </li>
          ))}
        ...
        >
          ...
          <span className="text-indigo-600 text-sm font-medium font-['Inter'] leading-none">파일 추가하기</span>
        </button>
